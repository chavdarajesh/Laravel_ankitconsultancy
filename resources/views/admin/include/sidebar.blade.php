    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ $current_route_name == 'admin.get.first_payment' || $current_route_name == 'admin.get.all_payment' || $current_route_name == 'admin.get.not_verified_payment' ? 'open active' : '' }}"
            ...
            <a href="{{ route('admin.get.first_payment') }}" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">All Payment</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ $current_route_name == 'admin.get.first_payment' ? 'active' : '' }}">
                    <a href="{{ route('admin.get.first_payment') }}" class="menu-link">
                        <div data-i18n="Without menu">First Payment</div>
                    </a>
                </li>
                <li class="menu-item {{ $current_route_name == 'admin.get.not_verified_payment' ? 'active' : '' }}">
                    <a href="{{ route('admin.get.not_verified_payment') }}" class="menu-link">
        ...
        <li class="menu-item {{ $current_route_name == 'admin.get.emi_option' || $current_route_name == 'admin.get.qr_code' || $current_route_name == 'admin.get.bankdetails' || $current_route_name == 'admin.get.emi_amount' || $current_route_name == 'admin.edit.emi_amount' || $current_route_name == 'admin.edit.qr_code' ? 'open active' : '' }}"
            ...
            <ul class="menu-sub">
                <li
                    class="menu-item {{ $current_route_name == 'admin.get.emi_option' || $current_route_name == 'admin.get.emi_amount' || $current_route_name == 'admin.edit.emi_amount' ? 'active' : '' }}">
                    <a href="{{ route('admin.get.emi_option') }}" class="menu-link">
                        <div data-i18n="Without menu">EMI Amoount</div>
                    </a>
                </li>
                <li
                    class="menu-item {{ $current_route_name == 'admin.get.qr_code' || $current_route_name == 'admin.edit.qr_code' ? 'active' : '' }}">
                    <a href="{{ route('admin.get.qr_code') }}" class="menu-link">
                        <div data-i18n="Without menu">QR Code</div>
                    </a>
                </li>
                <li class="menu-item {{ $current_route_name == 'admin.get.bankdetails' ? 'active' : '' }}">
                    <a href="{{ route('admin.get.bankdetails') }}" class="menu-link">
                        <div data-i18n="Without menu">Bank Details</div>
                    </a>
                </li>
            </ul>
        </li>
