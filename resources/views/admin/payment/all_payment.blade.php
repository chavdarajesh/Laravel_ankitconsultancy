...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Payment /</span> ALL Payment</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <h5 class="card-header">All Payment</h5>
                                            ...
                                            <div class="modal fade" id="payment-delete-modal-{{ $Payment->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('admin.delete.all_payment', $Payment->id) }}"
                                                                method="post">
    ...
    <script>
        ...
        $(function() {
            $('.payment_verified').change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ route('admin.update.all_payment.is_verified') }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
            ...
            $('.payment_status').change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ route('admin.update.all_payment.status') }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        'status': status,
                        'id': id
