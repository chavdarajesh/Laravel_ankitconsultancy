                                ...
                                @foreach ($Payments as $Payment)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <span class="badge bg-info">Yes</span></td>
                                            @else
                                        ...
                                        <td class="text-center"> <input data-id="{{ $Payment->id }}" class="payment_status" type="checkbox"
                                                data-onstyle="success" data-offstyle="danger" data-toggle="toggle"
                                                data-on="Active" data-off="InActive"
                                                {{ $Payment->status ? 'checked' : '' }}></td>
                                        <td class="text-center"> <input data-id="{{ $Payment->id }}" class="payment_verified" type="checkbox"
                                                data-onstyle="success" data-offstyle="danger" data-toggle="toggle"
                                                data-on="Verified" data-off="Not Verified"
                                                {{ $Payment->is_verified ? 'checked disabled' : '' }}></td>
                                        <td class="text-center">{{ $Payment->created_at }}</td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-icon btn-outline-danger" data-bs-toggle="modal" data-bs-target="#payment-delete-modal-{{ $Payment->id }}">
