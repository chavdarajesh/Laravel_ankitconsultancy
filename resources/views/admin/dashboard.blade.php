                    ...
                    <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                    <a class="dropdown-item" href="{{route('admin.get.all_payment')}}">View
                                        More</a>
                                </div>
                            </div>
                        </div>
                        <span class="fw-semibold d-block mb-1">Total Payments</span>
                        <h3 class="card-title mb-2"><i class='bx bx-wallet'></i><span class="badge badge-center bg-primary">{{$data['Total_Payments']}}</span>   </h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    You have done Total Amount OF Pyament is <span class="badge bg-label-success">{{$data['Total_Payments_Sum']}}</span> Rs  ..!
                                </p>

                                <a href="{{route('admin.get.all_payment')}}" class="btn btn-sm btn-outline-primary">View Payments</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span class="fw-semibold d-block mb-1">Total Verified Payments</span>
                                <h3 class="card-title mb-2">  <i class='bx bx-credit-card-front' ></i> <span class="badge badge-center bg-success">{{$data['Total_Verified_Payments']}}</span> </h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <span class="fw-semibold d-block mb-1">Total Not Verified Payments</span>
                                <h3 class="card-title mb-2">    <i class='bx bxs-credit-card-front'></i> <span class="badge badge-center bg-danger">{{$data['Total_Not_Verified_Payments']}}</span></h3>
                            </div>
                        </div>
                    </div>
