        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.get.emi_option') }}"><i class='bx bxs-wallet me-1' ></i> EMI
                            Amoount
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="javascript:void(0);"><i class='bx bxs-bank me-1'></i> Bank
                            Details</a>
                    </li>
                </ul>
                <div class="card mb-4">
