            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 content order-last  order-lg-first">
                        <h1>Privacy Policy for FINANCIAL ADVISOR</h1>

                        <p>At FINANCIAL ADVISOR, accessible from https://ankitconsultancy.com/, one of our main priorities
                            is the privacy of our visitors. This Privacy Policy document contains types of information that
                            is collected and recorded by FINANCIAL ADVISOR and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in FINANCIAL ADVISOR.
                        ...
                        <p>FINANCIAL ADVISOR follows a standard procedure of using log files. These files log visitors when
                        ...
                        <p>Like any other website, FINANCIAL ADVISOR uses 'cookies'. These cookies are used to store
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                            that are used in their respective advertisements and links that appear on FINANCIAL ADVISOR,
                        ...
                        <p>Note that FINANCIAL ADVISOR has no access to or control over these cookies that are used by
                            third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>FINANCIAL ADVISOR's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <p>FINANCIAL ADVISOR does not knowingly collect any Personal Identifiable Information from children
