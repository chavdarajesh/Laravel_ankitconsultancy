...
@endphp
    <main id="main">
        ...
        <div class="breadcrumbs">
            <div class="page-header d-flex align-items-center" style="background-image: url({{asset('assets/front/img/page-header.jpg') }});">
                <div class="container position-relative">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2>Services</h2>
                            <p>We Are Providing Financial Advice To Help Transform Your Business.</p>
                        </div>
                    </div>
                </div>
            </div>
